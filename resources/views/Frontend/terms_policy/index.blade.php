...
@section('mainContent')
    ...
    <div class="portfolio">
        <div class="container">
            <h5>Welcome to Hairck Saloon!</h5>

            <p>These terms and conditions outline the rules and regulations for the use of Hairck Saloon's Website,
                located at hs.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Hairck
                Saloon if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing Hairck Saloon, you agreed to use cookies in agreement with the
                Hairck Saloon's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Hairck Saloon and/or its licensors own the intellectual property rights for all
                material on Hairck Saloon. All intellectual property rights are reserved. You may access this from
                Hairck Saloon for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Hairck Saloon</li>
                <li>Sell, rent or sub-license material from Hairck Saloon</li>
                <li>Reproduce, duplicate or copy material from Hairck Saloon</li>
                <li>Redistribute content from Hairck Saloon</li>
            </ul>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Hairck Saloon does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of Hairck Saloon,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Hairck Saloon shall not be liable for the Comments
            ...
            <p>Hairck Saloon reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant Hairck Saloon a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Hairck Saloon; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Hairck Saloon. Please include your name, your
            ...
            <p>No use of Hairck Saloon's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
