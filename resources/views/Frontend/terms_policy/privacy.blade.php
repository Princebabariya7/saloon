...
@section('mainContent')
    ...
    <div class="portfolio">
        <div class="container">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Hairck Saloon.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Hairck Saloon, accessible from <a href="hs.com"
                                                                                            rel="external nofollow noopener"
                                                                                            target="_blank">hs.com</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: haricksaloon@gmail.com</li>
            </ul>
        </div>
    </div>
@endsection
